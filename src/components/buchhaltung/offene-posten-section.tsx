...
/** Offene/überfällige Rechnungen + Mahnungen (Buchhaltung-Tab „Offene Posten"). */
export async function OffenePostenSection() {
  ...
  if (open.length === 0) {
    return <EmptyState title="Keine offenen Posten" description="Alle Rechnungen sind bezahlt. 🎉" />;
  }
